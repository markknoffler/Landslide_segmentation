...
\begin{figure*}[!t]
\centering
\includegraphics[width=0.98\textwidth,height=0.20\textheight,keepaspectratio]{figures/fig26_bijie_qual.png}\\[0.3em]
\includegraphics[width=0.98\textwidth,height=0.20\textheight,keepaspectratio]{figures/fig27_l4s_qual.png}
...
\centering
\includegraphics[width=\linewidth,height=0.15\textheight,keepaspectratio]{figures/ablation/fig_ablation_f1_dual.png}
\caption{F1 dual-dataset}
\label{fig:abl_f1}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.32\textwidth}
\centering
\includegraphics[width=\linewidth,height=0.15\textheight,keepaspectratio]{figures/ablation/fig_ablation_delta_f1.png}
\caption{Matched \(\Delta\)F1}
\label{fig:abl_delta}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.32\textwidth}
\centering
\includegraphics[width=\linewidth,height=0.15\textheight,keepaspectratio]{figures/ablation/fig_ablation_iou_dual.png}
\caption{IoU dual-dataset}
\label{fig:abl_iou}
\end{subfigure}\\[0.2em]
\begin{subfigure}[t]{0.32\textwidth}
\centering
\includegraphics[width=\linewidth,height=0.15\textheight,keepaspectratio]{figures/ablation/fig_ablation_component_help.png}
\caption{Signed module help}
\label{fig:abl_help}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.32\textwidth}
\centering
\includegraphics[width=\linewidth,height=0.15\textheight,keepaspectratio]{figures/ablation/fig_ablation_mechanism_swaps.png}
\caption{Mechanism swaps}
\label{fig:abl_mech}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.32\textwidth}
\centering
\includegraphics[width=\linewidth,height=0.15\textheight,keepaspectratio]{figures/ablation/fig_ablation_cross_rank.png}
