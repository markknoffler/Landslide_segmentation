"""Tri-Temporal Tri-Stream Bridge (TTEB) — skip fusion across rgb, dem, fm pyramids."""
...
class TriTemporalTriStreamBridge(nn.Module):
    """Combine prev/present/next features across rgb, dem, and fm pyramids at one level."""
    ...
    def _attention_on_maps(self, anchor: torch.Tensor, context: torch.Tensor) -> torch.Tensor:
